...
const Featured = ({ image }) => {
  return (
    <div className='featured-news__card position-relative'
      style={{
        background: `
        linear-gradient(180deg, rgba(0, 0, 47, 0.00) 0%, #00002F 100%), /* Linear gradient */
        url(${image}) center center/cover no-repeat /* Image background */
      `
      }}
    >
      <div className='d-flex position-absolute featured-news__tags_wrapper'>
        <p className='mb-0 featured-news__tag me-3'>Bitcoin</p>
        <p className='mb-0 featured-news__tag'>Ethereum</p>
      </div>
      <div className='featured-news__details_wrapper position-absolute'>
        <div className='d-flex align-items-center mb-2'>
          <div className='pe-1 oak-news_logo__wrapper'>
            <img src={logo} alt='icon' />
          </div>
          <p className='mb-0 oak-news__text pt-1 text-white'>Oak News</p>
        </div>

        <h3 className='oak-news__title text-white'>
